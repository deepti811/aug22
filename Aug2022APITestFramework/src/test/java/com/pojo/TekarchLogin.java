...
public class TekarchLogin {
	...
	loginRequestPOJO.setUsername("deepti.solanki08@gmail.com");
	loginRequestPOJO.setPassword("deepti123");
	Response res=	RestAssured
		.given()
...
//		.body("{\"username\":\"deepti.solanki08@gmail.com\",\"password\":\"deepti123\"}")
	...
	LoginResponcePOJO[]  responsePojo= res.as(LoginResponcePOJO[].class);
	System.out.println("Response :" + responsePojo[0].getToken());
	res.prettyPrint();	
	//res.then
	}
	...
	UserDetailsPOJO[] userDetail=res.as(UserDetailsPOJO[].class);
	System.out.println("Size:      "+userDetail.length);
	...
	public static void createUSerDetails() {
		Header header=new Header("token",login());
		UserDetailsPOJO addData=new UserDetailsPOJO();
		addData.setAccountno("TA-Aug2202");
		addData.setDepartmentno("1");
		addData.setSalary("5000");
		addData.setPincode("123123");
		Response res= RestAssured
		.given()
		.header(header)
		.contentType(ContentType.JSON)
	...
	public static void updateUSerDetails() {
		...
		UserDetailsPOJO updateData=new UserDetailsPOJO();
		updateData.setAccountno("TA-Aug2202");
		updateData.setDepartmentno("3");
		updateData.setSalary("6000");
		updateData.setPincode("123123");
		updateData.setUserid("f4dTFeiZ4qiLC5JTtieF");
		updateData.setId("5IxVK1gM4FVtR7HCT7Ae");
		Response res= RestAssured.given()
				
		.header(header)
		.contentType(ContentType.JSON)
		//.body("{\"accountno\":\"TA-Aug2202\",\"departmentno\":3,\"salary\":6000,\"pincode\":123123,\"
		//userid\":\"f4dTFeiZ4qiLC5JTtieF\","+ "\"id\":\"5IxVK1gM4FVtR7HCT7Ae\"}")
		.body(updateData)
		.when()
		.put("updateData");
	...
	public static void deleteUserInfo() {
		String token1=login();
		Header header=new Header("token",token1);
		UserDetailsPOJO deleteData=new UserDetailsPOJO();
		deleteData.setUserid("f4dTFeiZ4qiLC5JTtieF");
		deleteData.setId("5IxVK1gM4FVtR7HCT7Ae");
		Response res= RestAssured.given()
		.header(header)
		.contentType(ContentType.JSON)
